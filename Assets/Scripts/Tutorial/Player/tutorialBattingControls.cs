...
public class tutorialBattingControls : MonoBehaviour
{
    [SerializeField] private Animator playerAnimator = null;
    [SerializeField] private float hitWindow = 0.5f;
    [SerializeField] private float hitCooldown = 0.5f;
    [SerializeField] private tutorialPlayerDash dashCont = null;
    ...
    public void Batting(CallbackContext context)
    {
        ...
        {
            case false:
                if (context.performed && isHitting == false && PauseMenu.isPaused == false && TutorialStateMachine.GetCurrentState() != TutorialState.FROZEN)
                {
